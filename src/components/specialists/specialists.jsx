      ...
      <div className="container">
        ...
        <Row className="mb-5">
          {/* <Col lg={6} md={6} sm={12}>
            ...
            <h1 className="mb-3 fw-semibold">Hello! This is <span className="text-primary">Rwanda Eye Clinic</span></h1>
          </Col> */}
...
{/*        
       ...
       */}
        ...
        <Row>
          <div className="text-center my-5">
            <h2 className="fw-semibold">Meet Doctors</h2>
            <h5 className="mb-2">Specialists Descriptions here,Specialists Descriptions, Specialists Descriptions,Specialists Descriptions</h5>
            <h5 className="mb-0">Specialists Descriptions,Specialists Descriptions</h5>
          </div>
